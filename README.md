...
<br />
<p align="center">
Azure Sentinel Incident View. I created an alert rule for the failed logons. (Please excuse the misspelling of logons in the pic) <br/>
...
<br />
<br />
Powershell Script ran on the VM and results. The PS script extracts metadata from Windows Event Viewer and forwards it to a third party API to get geolacation data from attacks. The events are saved in a file on the VM and sent to Azure. <br/>
